...
//            }
//        });
        myHolder.priseimage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (myHolder.priseimage.isChecked()){
                    count++;
                    myHolder.prisecount.setText(count+"");
                }
            }
        });
    }
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        private final CheckBox priseimage;
