...
public class ImageAdapter02 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<Object> mList;
    private Activity activity;
    private LayoutInflater inflater;
    private int sign;//0:普通点击，1自定义
    public ImageAdapter02(List<Object> mList, Activity activity) {
        this.mList = mList;
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        ...
        public MyHolder(@NonNull View itemView) {
            super(itemView);
            draweeView = itemView.findViewById(R.id.circle_image01);
        }
    }
}
