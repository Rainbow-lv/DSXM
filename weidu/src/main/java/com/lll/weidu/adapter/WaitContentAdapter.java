...
public class WaitContentAdapter extends RecyclerView.Adapter<WaitContentAdapter.MyHolder> {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.waite_item_layout, viewGroup, false);
